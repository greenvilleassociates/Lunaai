...
import { a as findClosestIonContent, d as disableContentScrollY, r as resetContentScrollY } from './index-B_8X7INq.js';
import { j as isSafeNumber, e as clamp, d as debounceEvent, i as inheritAriaAttributes, a as renderHiddenInput } from './helpers-DkCLSLI9.js';
...
const Range = class {
    ...
    render() {
        ...
        return (h(Host, { key: '81119ccd58016522bdac455a4e832d28b8d22d13', onFocusin: this.onFocus, onFocusout: this.onBlur, id: rangeId, class: createColorClasses(this.color, {
                [mode]: true,
                'in-item': inItem,
            ...
            }) }, h("label", { key: 'fac472b1d252560e83ca85bcc3eec6fec90d2cdf', class: "range-wrapper", id: "range-label" }, h("div", { key: '2d920cde50fdac003caa902c945e2ac71160e701', class: {
                'label-text-wrapper': true,
                'label-text-wrapper-hidden': !hasLabel,
            }, part: "label" }, label !== undefined ? h("div", { class: "label-text" }, label) : h("slot", { name: "label" })), h("div", { key: 'f81e7c7c9f6620b7c5f848689adb67402aa508d1', class: "native-wrapper" }, h("slot", { key: '29bcf499b855fa4f3d3069b8a9efbdc1a5b32f0e', name: "start" }), this.renderRangeSlider(), h("slot", { key: '5c1b25c5ca6a8a05e102648db85b9c8d1c86de25', name: "end" })))));
    }

...
import { o as getPresentedOverlay, B as BACKDROP, n as focusFirstDescendant, q as focusLastDescendant, G as GESTURE } from './overlays-COCl_nm9.js';
...
import { o as isEndSide, i as inheritAriaAttributes, l as assert, e as clamp } from './helpers-DkCLSLI9.js';
import { m as menuController } from './index-DdeElWma.js';
...
import './framework-delegate-B9yvYzqV.js';
...
const Menu = class {
    ...
    render() {
         ...
         */
        return (h(Host, { key: 'e97587ece74feec95a3526bf4823538feb3b9ffc', onKeyDown: shouldUseCloseWatcher() ? null : this.onKeydown, role: "navigation", "aria-label": inheritedAttributes['aria-label'] || 'menu', class: {
                [mode]: true,
                [`menu-type-${type}`]: true,
            ...
            } }, h("div", { key: '0a8694d1772558f18b38332b3936d0f21fd35ce7', class: "menu-inner", part: "container", ref: (el) => (this.menuInnerEl = el) }, h("slot", { key: '51fe03c098ed8a7f8ecdb12a1649424b4adfa59a' })), h("ion-backdrop", { key: 'cd53a4d9ffef157bd95c652be76c92961f0ff480', ref: (el) => (this.backdropEl = el), class: "menu-backdrop", tappable: false, stopPropagation: false, part: "backdrop" })));
    }

...
var hardwareBackButton = require('./hardware-back-button-CXmUnTJC.js');
...
var index$2 = require('./index-CukZnH1U.js');
    ...
    componentDidLoad() {
        {
            this.rIC(async () => {
                ...
                if (!index.config.getBoolean('_testing')) {
                    Promise.resolve().then(function () { return require('./index-MWAIyVLl.js'); }).then((module) => module.startTapClick(index.config));
                }
                if (index.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-7FzRlXNr.js'); }).then((module) => module.startStatusTap());
                }
                if (index.config.getBoolean('inputShims', needInputShims())) {
                    ...
                    Promise.resolve().then(function () { return require('./input-shims-CPKgrIe3.js'); }).then((module) => module.startInputShims(index.config, platform));
                }
...
const Content = class {
    ...
    render() {
        ...
        this.resize();
        return (index.h(index.Host, Object.assign({ key: '9551c759df407b10d809171641fc6e8f14d92219', role: isMainContent ? 'main' : undefined, class: theme.createColorClasses(this.color, {
                [mode]: true,

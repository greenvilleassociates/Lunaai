...
const ItemOption = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b576e8f449ee9a03e659abd923421b051f7427c8', onClick: this.onClick, class: theme.createColorClasses(this.color, {
                [mode]: true,
                'item-option-disabled': disabled,
                'item-option-expandable': expandable,
                'ion-activatable': true,
            }) }, index.h(TagType, Object.assign({ key: '568c7de194ecef7d1efec2abdf855b3fce71aa03' }, attrs, { class: "button-native", part: "native", disabled: disabled }), index.h("span", { key: 'fe1a494a40febc5c415098d8c9b2edad9fac02c9', class: "button-inner", part: "inner" }, index.h("slot", { key: '8e4ec73c1a9c047a29dac8ad09ff1cce94a751c7', name: "top" }), index.h("div", { key: '7828c6413d2cab692a3a2e5aa2a17240e0dcb230', class: "horizontal-wrapper", part: "container" }, index.h("slot", { key: 'c8eb9881db296280ba895ab249e5d1bb3fc27206', name: "start" }), index.h("slot", { key: '144b18f7ea90a45abbe0b1fa878c87e623897b7b', name: "icon-only" }), index.h("slot", { key: '6c63ebad29552a32e1ed9ca3c95aa005b35b9b86' }), index.h("slot", { key: '99478d52600bf32342649a2f74ed8e1eb07407d4', name: "end" })), index.h("slot", { key: '00247fc54e61cface4e6ac6e8ea05a0685f5e26e', name: "bottom" })), mode === 'md' && index.h("ion-ripple-effect", { key: 'dc5057f2ff0926b2e5fd1520fed6cf7dc3197cf8' }))));
    }
...
const ItemSliding = class {
    ...
    async connectedCallback() {
        ...
        await this.updateOptions();
        this.gesture = (await Promise.resolve().then(function () { return require('./index-BJ2-LydH.js'); })).createGesture({
            el,

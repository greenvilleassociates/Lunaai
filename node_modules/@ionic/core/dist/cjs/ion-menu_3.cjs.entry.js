...
var index$1 = require('./index-DOiZqxWZ.js');
...
const Menu = class {
    ...
    render() {
         ...
         */
        return (index.h(index.Host, { key: 'e97587ece74feec95a3526bf4823538feb3b9ffc', onKeyDown: hardwareBackButton.shouldUseCloseWatcher() ? null : this.onKeydown, role: "navigation", "aria-label": inheritedAttributes['aria-label'] || 'menu', class: {
                [mode]: true,
                [`menu-type-${type}`]: true,
            ...
            } }, index.h("div", { key: '0a8694d1772558f18b38332b3936d0f21fd35ce7', class: "menu-inner", part: "container", ref: (el) => (this.menuInnerEl = el) }, index.h("slot", { key: '51fe03c098ed8a7f8ecdb12a1649424b4adfa59a' })), index.h("ion-backdrop", { key: 'cd53a4d9ffef157bd95c652be76c92961f0ff480', ref: (el) => (this.backdropEl = el), class: "menu-backdrop", tappable: false, stopPropagation: false, part: "backdrop" })));
    }

...
const ItemDivider = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'ff2ae8eee7704ca28e3f25a39fc3d910f57b1879', class: theme.createColorClasses(this.color, {
                [mode]: true,
                'item-divider-sticky': this.sticky,
                item: true,
            }) }, index.h("slot", { key: '9747421ee3c6b8012ad5a71091aa9775d002885e', name: "start" }), index.h("div", { key: '0ad8e1355c70efcc095b954c29af497a18b35b37', class: "item-divider-inner", part: "inner" }, index.h("div", { key: '7562f4f033e786b620ef2bd62d7c35f1013b4905', class: "item-divider-wrapper", part: "container" }, index.h("slot", { key: '013a0c58ca93afa395a52df30020d1b9e86ffc3a' })), index.h("slot", { key: 'a08f7b7a133110cbb51b1f4843133bacc306d3a1', name: "end" }))));
    }
    get el() { return index.getElement(this); }
};
ItemDivider.style = {
...
const Label = class {
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'd603670c442213c28737b0c052c094705b8c84ef', class: theme.createColorClasses(this.color, {
                [mode]: true,
                'in-item-color': theme.hostContext('ion-item.ion-color', this.el),
                [`label-${position}`]: position !== undefined,
                [`label-no-animate`]: this.noAnimate,
                'label-rtl': document.dir === 'rtl',
            }) }, index.h("slot", { key: 'a8c3aed240a20ee5856c423662878481a1e6d4cf' })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "color": [{
...
const ListHeader = class {
    ...
    render() {
        const { lines } = this;
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'f5fcd3e6b9f1ba52381fd0d14c0d50517da50f9f', class: theme.createColorClasses(this.color, {
                [mode]: true,
                [`list-header-lines-${lines}`]: lines !== undefined,
            }) }, index.h("div", { key: '99d09b1d2438ad981d20ff965c8945635c2161a3', class: "list-header-inner", part: "inner" }, index.h("slot", { key: 'efa7ab08935cfa378734cda0612b49ba5b7b6d36' }))));
    }
};
ListHeader.style = {

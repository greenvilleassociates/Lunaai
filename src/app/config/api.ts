...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    // AccuWeather Forecast (uses /api/accuweather/{query})
    ACCUWEATHER: (query: string) => `/accuweather/${encodeURIComponent(query)}`,

    // Voice Response TTS (uses /api/VoiceResponse)
    VOICE_RESPONSE: '/VoiceResponse',
    VOICE_RESPONSE_COMPLETE: '/VoiceResponse/Complete',
...
/**
 * Helper function for making API requests WITHOUT authentication headers
 * Used for endpoints that don't require auth (e.g., Addbase)
 */

...
// ─── Exported constants consumed by Settings.tsx ─────────────────────────────
...
export const ALL_LOG_APIS: {
  ...
  { key: "adminlogs",    label: "Admin Logs",      icon: AdminPanelSettings, color: "#8B0000", endpoint: "/Adminlogs"   },
  { key: "apilogs",      label: "API Logs",         icon: Api,                color: "#0891b2", endpoint: "/Apilogs"     },
  { key: "authnotices",  label: "Auth Notices",     icon: Warning,            color: "#d97706", endpoint: "/Auth"        },
  { key: "sysadminlogs", label: "SysAdmin Logs",    icon: Shield,             color: "#7c3aed", endpoint: "/Usersession" },
  { key: "useractions",  label: "User Actions",     icon: Lock,               color: "#059669", endpoint: "/Userlog"     },
  { key: "userlogs",     label: "User Logs",        icon: Person,             color: "#3b82f6", endpoint: "/Userlog"     },
  { key: "usernotices",  label: "User Notices",     icon: Notifications,      color: "#f59e0b", endpoint: "/Userhelp"    },
  { key: "usersessions", label: "User Sessions",    icon: AccessTime,         color: "#64748b", endpoint: "/Usersession" },
];
